...
object PermissionUtil {
    ...
    fun requiredPermissions(context: Activity, permissions: List<String>): List<String> {
    ...
    fun shouldShowRequestPermissionRationale(context: Activity, permissions: List<String>): Boolean {
        return permissions.all { ActivityCompat.shouldShowRequestPermissionRationale(context, it) }
    }
}